...
Existing photo previews MUST use short-lived authorized URLs resolved after the parent memory is
authorized; the interface and mutation request MUST NOT expose or accept Storage object paths.
