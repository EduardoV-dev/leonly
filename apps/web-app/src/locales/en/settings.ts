export const settingsEn = {
  ...
  startDate: {
    acceptCurrent: "Use current date",
    cancel: "Cancel",
    conflict: "The current start date is {{date}}.",
    edit: "Edit start date",
    failed: "We could not save this start date. Try again.",
    pending: "Saving…",
    placeholder: "Choose a date",
    retry: "Retry saved date",
    save: "Save date",
    success: "Start date saved.",
    validation: "Choose a valid date.",
  },
  summary: {
