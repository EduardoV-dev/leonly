...
create index spaces_is_active_idx
...
create unique index space_members_active_user_unique_idx
  on public.space_members (user_id)
  where is_active = true;

create unique index space_members_active_space_user_unique_idx
  on public.space_members (space_id, user_id)
  where is_active = true;

create unique index space_members_active_space_role_unique_idx
...
create index space_members_is_active_idx
