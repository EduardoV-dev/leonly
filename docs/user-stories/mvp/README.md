...
These flows still require the lifecycle and authorization verification in US-027 before MVP release.
...
- Timeline, Vault, places, and comments use bounded cursor pagination with deterministic secondary ordering. OpenSpec defines page sizes and each list's primary sort.
...
- [ ] [US-028 View memory detail](02-memories/us-028-view-memory-detail.md) - Planned
...
- [ ] [US-029 Set preferred currency](07-settings/us-029-set-preferred-currency.md) - Planned
...
- [ ] [US-027 Enforce space lifecycle](09-access-and-onboarding/us-027-space-lifecycle.md) - Partial

## Recommended Order

1. US-027 and US-025: verify lifecycle invariants and establish authorization before private feature data is introduced.
...
7. US-001: replace remaining dashboard placeholders once memory and place queries exist.
8. US-026: verify shared UI states and accessibility across completed paths.
